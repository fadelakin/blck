...
public class CameraActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFolder = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Blck");
     ...
     */
    // TODO: Save image to blck folder rather than a random ass folder
    private void captureStillPicture() {
        try {
            ...
            mFile = new File(mFolder, "blck_" + timeStamp + ".jpg");
